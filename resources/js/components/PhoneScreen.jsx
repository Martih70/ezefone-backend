...
export default function PhoneScreen({ onBack }) {
    ...
    return (
        <div className="w-full h-full flex flex-col bg-amber-50" style={patternStyle}>
            {/* Header */}
            <div className="bg-amber-50 border-b-4 border-emerald-600 p-6 flex justify-between items-center shadow-sm">
                <div className="flex items-center gap-3">
                    <h1 className="text-3xl font-bold text-slate-950">Phone</h1>
                </div>
                <button
                    onClick={onBack}
